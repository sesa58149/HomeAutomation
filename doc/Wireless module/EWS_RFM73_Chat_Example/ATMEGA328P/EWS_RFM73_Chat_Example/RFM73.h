...
#define CE   2		// PC2 	(Chip enable) - OUTPUT

#define CSN  2		// PB2 	(Chip Select) - OUTPUT
#define SCK  5		// PB5 	(SPI Clock) - OUTPUT
#define MISO 4		// PB4 	(MOSI - Master out/Slave in) - OUTPUT
#define MOSI 3		// PB3 	(MISO - Master in/slave out) - INPUT

#define RED_LED 1	// PB1 (RED LED)
#define GREEN_LED 0	// PB0 (GREEN LED)

#define USART_BAUDRATE 4800	// UART0 Baudrate
#define BAUD_PRESCALE (((F_CPU / (USART_BAUDRATE * 16UL))) - 1) // UART0 Baud Prescale value for UBRR register
