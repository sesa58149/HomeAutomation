...
#define MASTER_OUT_SLAVE_ENABLE_BIT 0 // PB0 to control slave operation with respect to water level 	

#define MASTER_OUT_SLAVE_ENABLE() (PORTB|=(1<<MASTER_OUT_SLAVE_ENABLE_BIT))
#define MASTER_OUT_SLAVE_DISABLE()(PORTB&=~(1<<MASTER_OUT_SLAVE_ENABLE_BIT))
...
#define INPUT_PIN_MASK				0xE0 //0b1110 0000 pd6,5  pd7 used in manual start
